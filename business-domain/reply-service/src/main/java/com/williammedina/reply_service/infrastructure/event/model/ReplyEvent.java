package com.williammedina.reply_service.infrastructure.event.model;
...
public record ReplyEvent(
        ...
        @Schema(description = "Nombre del servicio que emitió el evento", example = "reply-service")
    ...
    public ReplyEvent(ReplyEventType eventType, String sourceService, JsonNode payload) {
